...
class RTP_ControlFrame : public PBYTEArray
{
  ...
  public:
    ...
    PBoolean GetPadding() const { return theArray[compoundOffset & 0x20] != 0; }
    void SetPadding(PBoolean v) { if (v) theArray[compoundOffset] |= 0x20; else theArray[compoundOffset] &= 0xdf; }
